...
import { useTransactionId } from "@/hooks/use-transaction";
import { GeneralChevronRi } from "@/components/ui/icons/general-chevron-ri";
import { GeneralShare } from "@/components/ui/icons/general-share";
import { GeneralDownload } from "@/components/ui/icons/general-download";
...
export default function TransactionDetailScreen() {
  ...
  const { data: response, isLoading } = useTransactionId(id);

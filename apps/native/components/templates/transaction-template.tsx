...
import type { InferResponseType } from "../../../server/src/type";
...
export default function TransactionTemplate() {
  ...
  // Fetch real API data
  const { data: response, isLoading } = useTransactionList({
    limit: 20,
    type: filterType,
  });
